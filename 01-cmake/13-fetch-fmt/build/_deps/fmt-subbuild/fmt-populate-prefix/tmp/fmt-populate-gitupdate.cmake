...
execute_process(
  COMMAND "/usr/bin/git" show-ref "e69e5f977d458f2650bb346dadf2ad30c5320281"
  WORKING_DIRECTORY "/home/zjp/code/cpp-prj/repo-parallel101/01-cmake/13-fetch-fmt/build/_deps/fmt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/zjp/code/cpp-prj/repo-parallel101/01-cmake/13-fetch-fmt/build/_deps/fmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/zjp/code/cpp-prj/repo-parallel101/01-cmake/13-fetch-fmt/build/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
